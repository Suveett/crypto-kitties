          ...
          <div id="kitty${id}" class="catBoxLarger mt-4 light-b-shadow">
            ...
            <div id="cat" class="cat">
                ...
                <div class="cat__body">
                    ...
                    <div id="leftPaw" class="cat__paw-left"></div>
                    <div id="leftInnerPaw" class="cat__paw-left_inner"></div>


                    <div id="rightPaw" class="cat__paw-right"></div>
                    <div id="rightInnerPaw"class="cat__paw-right_inner"></div>
...
function displayBirth(newborn) {
    try {
        ...
        $("#kittyCreation").text("A new kitty is born!  Kitty ID:" + newborn.newKittenId +
                                "\nGenes:" + newborn.genes +
...
// Event Handler for displaying a New Market Transaction :
